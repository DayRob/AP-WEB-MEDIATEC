...
--
-- Creation tables Abonne et typeAbonnement et mise en place FK
--
...
CREATE TABLE typeAbonnement
	(id int(7),
	 libelle varchar(20),
	 CONSTRAINT pk_typeAbonnement PRIMARY KEY (id)
	 ) ENGINE=InnoDB;


ALTER TABLE Abonne ADD CONSTRAINT FK_Abonne FOREIGN KEY (idTypeAbonnement) REFERENCES typeAbonnement(id);
