                        ...
                        <div class="card-footer bg-white px-0 ">
                            <div class="row">
                                ...
                                <div class=" col-md-auto ">
                                    ...
                                    <a href="./?action=historiqueRecherche" name="suprimmerRecherche" value="<?= $unHistorique->getId() ?>" class="btn btn-outlined btn-black text-muted "><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3" viewBox="0 0 16 16">
